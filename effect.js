...
$('document').ready(function(){
		...
		$(window).resize(function(){
			...
			$('#b11').animate({top: '30vh', left: `calc(50vw - 350px)`}, 500);
			$('#b22').animate({top: '30vh', left: `calc(50vw - 350px)`}, 500);
			$('#b33').animate({top: '30vh', left: `calc(50vw - 350px)`}, 500);
			$('#b44').animate({top: '30vh', left: `calc(50vw - 350px)`}, 500);
			$('#b55').animate({top: '30vh', left: `calc(50vw - 350px)`}, 500);
			$('#b66').animate({top: '30vh', left: `calc(50vw - 350px)`}, 500);
			$('#b77').animate({top: '30vh', left: `calc(50vw - 350px)`}, 500);
		});
